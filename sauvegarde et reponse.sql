L'èquipe a changè de moteur de BDD parceque la BDD non-relationnel ne leurs permet pas de 
reliè les BDD entre eux, tansdisque la BDD  relationnel leurs permettra de relier les tables entre eux.
...
CREATE TABLE `absorber` (
  ...
  CONSTRAINT `absorber_ibfk_1` FOREIGN KEY (`quantite`) REFERENCES `qualite` (`num_qualite`),
...
INSERT INTO `absorber` VALUES (2,'2052-02-01 00:00:00',12,4),(1,'2052-02-18 00:00:00',7,3),(1,'2052-02-20 00:00:00',2,2),(1,'2052-02-21 00:00:00',8,2),(3,'2052-02-22 00:00:00',7,1),(1,'2052-04-03 00:00:00',7,1),(1,'2052-04-04 00:00:00',15,2),(2,'2052-04-05 00:00:00',13,5),(3,'2052-04-06 00:00:00',10,4),(4,'2052-05-05 00:00:00',15,2),(5,'2052-05-10 00:00:00',1,4),(5,'2052-05-11 00:00:00',2,1),(1,'2052-06-06 00:00:00',13,2),(2,'2052-06-07 00:00:00',7,1),(3,'2052-06-08 00:00:00',8,4),(5,'2052-06-09 00:00:00',1,2),(5,'2052-07-17 00:00:00',7,1),(2,'2052-07-18 00:00:00',7,3),(1,'2052-08-19 00:00:00',8,3),(1,'2052-08-22 00:00:00',16,1),(4,'2052-08-24 00:00:00',7,2),(3,'2052-08-29 00:00:00',10,2),(3,'2052-09-20 00:00:00',7,5),(4,'2052-09-30 00:00:00',1,2),(2,'2052-10-23 00:00:00',7,4),(3,'2052-10-28 00:00:00',13,1),(4,'2052-10-31 00:00:00',13,3),(2,'2052-11-15 00:00:00',8,2),(5,'2052-11-16 00:00:00',13,2),(1,'2052-11-26 00:00:00',10,2),(5,'2052-11-27 00:00:00',16,2);
...
CREATE TABLE `cathegorie` (
  `code_cat` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
...
LOCK TABLES `cathegorie` WRITE;
/*!40000 ALTER TABLE `cathegorie` DISABLE KEYS */;
INSERT INTO `cathegorie` VALUES ('BCN','Bouclier de Centurion',6),('BDN','Bouclier de Décurion',4),('BLE','Bouclier de Légionnaire',3),('BLT','Bouclier de Légat',10),('CCN','Casque de Centurion',3),('CDN','Casque de Décurion',2),('CLE','Casque de Légionnaire',1),('CLT','Casque de Légat',4);
/*!40000 ALTER TABLE `cathegorie` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `potion` (
  ...
  `constituant_principal` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `trophee` (
  ...
  `code_cat` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `trophee_ibfk_3` FOREIGN KEY (`code_cat`) REFERENCES `cathegorie` (`code_cat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-22 13:36:05
